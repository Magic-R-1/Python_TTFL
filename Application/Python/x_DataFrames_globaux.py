...
def sauvegarder_cache_CommonPlayerInfo():
    ...
    file_path = f"C:/Users/egretillat/Documents/Personnel/Code/envPython/Python_TTFL/Application/Python/Cache/cache_CommonPlayerInfo.pkl"
...
def sauvegarder_cache_BoxScoreTraditionalV2():
    ...
    file_path = f"C:/Users/egretillat/Documents/Personnel/Code/envPython/Python_TTFL/Application/Python/Cache/cache_BoxScoreTraditionalV2.pkl"
    # Sauvegarder le cache dans le fichier
    with open(file_path, 'wb') as file:
