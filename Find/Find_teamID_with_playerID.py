...
def obtenir_equipe_joueur(joueur_id):
    try:
        ...
        equipe_actuelle = joueur_info['TEAM_ID'].iloc[0]
...
if equipe_joueur:
    print(f"L'équipe actuelle du joueur {joueur_id} est : {equipe_joueur}")
else:
    print(f"Impossible d'obtenir l'équipe du joueur.")