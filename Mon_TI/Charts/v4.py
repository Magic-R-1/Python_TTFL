...
def taille_origine_image(chemin):
    # Charger l'image
    img = Image.open(chemin)  # Remplacez "chemin_vers_votre_image/image.jpg" par le chemin de votre image
...
def ajout_image(y_min, y_max, team, x_position, y_position):
    ...
    taille_origine = taille_origine_image(chemin)
